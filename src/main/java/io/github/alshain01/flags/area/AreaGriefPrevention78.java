 ...
 */
final public class AreaGriefPrevention78 extends AreaGriefPrevention implements Subdividable {

	/**
	 * Creates an instance of AreaGriefPrevention78 based on a Bukkit Location
	 * 
	 * @param location
	 *            The Bukkit location
	 */
	public AreaGriefPrevention78(Location location) {
		super(location);
	}

	/**
	 * Creates an instance of AreaGriefPrevention78 based on a claim ID
	 * 
	 * @param id
	 *            The claim id
	 */
	public AreaGriefPrevention78(long id) {
		super(id);
	}
    ...
    public Area getParent() {
        if (isSubdivision()) return new AreaGriefPrevention78(claim);
        throw new InvalidSubdivisionException();
    }
